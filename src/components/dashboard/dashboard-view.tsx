...
export function DashboardView() {
  ...
  // Newest first regardless of storage backend ordering.
  ...
  const stats = [
    { label: "Total Leads", value: formatNumber(metrics.totalLeads), icon: Users, tone: "violet" as const, delta: isEmpty ? undefined : growthPct, hint: isEmpty ? undefined : "vs last month" },
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Activity + follow-ups + goals */}
      <div className="grid grid-cols-1 gap-4 lg:grid-cols-3">
        <Card>
          <CardHeader className="flex-row items-center justify-between">
            <div>
              <CardTitle className="text-base">Recent Activity</CardTitle>
              <CardDescription>Latest touchpoints</CardDescription>
            </div>
        ...
        <Card>
          ...
          <CardContent>
            <FollowUpPanel leads={leads} upcomingLimit={4} />
          </CardContent>
        </Card>
